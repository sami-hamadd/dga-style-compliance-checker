...
function ComplianceResult({ url }: { url: string }) {
       ...
       const formattedViolations = violations.map((violation) => ({
              violations: Object.fromEntries(Object.entries(violation.violations).map(([key, value]) => [key, Number(value)])),
       }));
       ...
       return (
              <Card w="90%" mt="md" p="md" bg="white" shadow="lg" radius="md" style={{ border: "1px solid #eee" }}>
                     {isLoading ? (
                            ...
                            <>
                                   <Paper withBorder p="xl" mb="sm" shadow="0">
                                          <Title order={3} mb="sm" ta="center">
                                                 Overall Typography & Colors Compliance Score
                                          </Title>
                                          <Center>
